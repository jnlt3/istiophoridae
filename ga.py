...
class Constraints:
    ...
    def _new_value(self, dna: Dna, index: int):
    ...
    def mutate(self, dna: Dna, mutation_chance: float):
...
class GeneticAlgorithm:
    ...
    def __init__(self, ga_params: GaParams):
        assert (
    ...
    def eliminate(self, select: Callable[[Dna, Dna], Dna]):
